        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a id="getAllUsers" href="#"><i class="fa fa-table fa-fw"></i> Tables</a>
                    </li>
                    <li>
                        <a  href="#"><i class="fa fa-edit fa-fw"></i> Forms</a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a id="getAllUsers1" href="#">用户管理</a>
                            </li>
                            <li>
                                <a id="admin-insertUser" href="#">增加用户</a>
                            </li>
                        </ul>
                    </li>
                    <li>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <table id="table_id" class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                        <tr>
                            <td>Row1Data1Row1Data1Row1Data1Row1Data1Row1Data1</td>
                            <td>Row1Data1Row1Data1Row1Data1Row1Data1Row1Data1</td>
                        </tr>
                        <tr>
                            <td>Row 2 Data 1</td>
...
<script src="js/admin-getUser.js"></script>
</body>
